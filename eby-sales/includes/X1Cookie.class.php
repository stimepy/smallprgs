...
class X1Cookie{
	...
	##############################################*/ //cookieread  
	function CookieRead($cookie_name='ebay_auctions'){
	...
	function CheckLogin($cookie_name=X1_cookiename) {
		...
		//cookie for teams
		if($cookie_name=='ebay_auctions'){
			if($my_cookie[0]!=$user_cookie[0] && $my_cookie[1]!=$user_cookie[1]){
				X1Cookie::RemoveCookie($cookie_name);
				return false;
			}	
		}
	...
	/*############################################
	Name:RemoveCookie
	What does it do: Removed the cookies needed for the XT System
	parms:int $set_id: Id of team/mod/user/whatever.  string $set_name: Name of team/mod/user/whatever
	returns: N/A
	##############################################*/ //setteamcookie  domodcookie
